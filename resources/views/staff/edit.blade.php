    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box">
                ...
                <form id="frmEditStaff" class="form-horizontal">
                    @csrf

                    <input id="id" name="id" type="hidden" value="{{ $staff->id }}" readonly>
                    ...
                    <div class="box-body">
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div id="div_code" class="col-sm-8">
                                <input id="code" name="code" type="text" class="form-control" placeholder="Código" maxlength="10" value="{{ $staff->code }}" autofocus required>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div id="div_name" class="col-sm-8">
                                <input id="name" name="name" type="text" class="form-control" placeholder="Nombre" maxlength="100" value="{{ $staff->name }}" required>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div id="div_dollarSalary" class="col-sm-8">
                                <input id="dollarSalary" name="dollarSalary" type="text" class="form-control" placeholder="Salario Dólares" maxlength="15" value="{{ $staff->dollarSalary }}" data-mask required>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div id="div_pesosSalary" class="col-sm-8">
                                <input id="pesosSalary" name="pesosSalary" type="text" class="form-control" placeholder="Salario Pesos" maxlength="15" value="{{ $staff->pesosSalary }}" readonly data-mask required>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div id="div_address" class="col-sm-8">
                                <input id="address" name="address" type="text" class="form-control" placeholder="Dirección" maxlength="100" value="{{ $staff->address }}" required>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div id="div_state" class="col-sm-8">
                                <input id="state" name="state" type="text" class="form-control" placeholder="Estado" maxlength="50" value="{{ $staff->state }}" required>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div id="div_city" class="col-sm-8">
                                <input id="city" name="city" type="text" class="form-control" placeholder="Ciudad" maxlength="50" value="{{ $staff->city }}" required>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div id="div_telephone" class="col-sm-8">
                                <input id="telephone" name="telephone" type="text" class="form-control" placeholder="Teléfono" maxlength="10" value="{{ $staff->telephone }}" data-mask required>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div id="div_email" class="col-sm-8">
                                <input id="email" name="email" type="email" class="form-control" placeholder="Correo" maxlength="191" value="{{ $staff->email }}" required>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div id="div_active" class="col-sm-8">
                                <label>
                                    <input name="active" type="radio" class="flat-purple" value="1" @if($staff->active == '1') checked @endif> S&iacute;
                                </label>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <label>
                                    <input name="active" type="radio" class="flat-purple" value="0" @if($staff->active == '0') checked @endif> No
                                </label>
...
@section('js')
    ...
    <script type="text/javascript">
        var urlStaff = "{{ route('staff.index') }}", urlUpdateStaff = "{{ route('staff.update') }}", urlWsStaff = "{{ route('staff.ws') }}";
    </script>
    <script src="{{ asset('dist/js/editStaff.js') }}"></script>
@endsection
